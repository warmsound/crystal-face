...
RUN apt-get update -qq && DEBIAN_FRONTEND=noninteractive apt-get install -y wget openjdk-8-jdk unzip build-essential xvfb libusb-1.0-0-dev xorg libpng12-0 libwebkitgtk-1.0-0
